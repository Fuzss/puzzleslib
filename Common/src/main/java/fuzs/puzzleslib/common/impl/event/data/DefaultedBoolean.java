package fuzs.puzzleslib.common.impl.event.data;

import fuzs.puzzleslib.common.api.event.v1.data.MutableBoolean;
import fuzs.puzzleslib.common.impl.event.data.event.EventDefaultedBoolean;
import fuzs.puzzleslib.common.impl.event.data.value.ValueDefaultedBoolean;
