...
public interface HotbarScrollingCallback {
     ...
     * @param horizontalScrollAmount the horizontal scroll amount
     * @param verticalScrollAmount   the vertical scroll amount
     * @return <ul>
     ...
     *         </ul>
     */
    EventResultHolder<Integer> onHotbarScrolling(Inventory inventory, int oldSlot, int newSlot, double horizontalScrollAmount, double verticalScrollAmount);
}
