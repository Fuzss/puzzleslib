package fuzs.puzzleslib.common.api.event.v1.data;

import fuzs.puzzleslib.common.impl.event.data.event.EventMutableBoolean;
import fuzs.puzzleslib.common.impl.event.data.value.ValueMutableBoolean;
