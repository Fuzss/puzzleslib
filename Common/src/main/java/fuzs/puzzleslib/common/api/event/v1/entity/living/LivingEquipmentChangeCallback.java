...
public interface LivingEquipmentChangeCallback {
    ...
    /**
     * Fires whenever equipment changes are detected on an entity in {@link LivingEntity#collectEquipmentChanges(Map)}
     * from {@link LivingEntity#tick()}. This runs before attributes supplied by the equipment are updated on the entity
     * and before the changed equipment is synced to clients.
     * <p>
     * Note that the callback does <b>NOT</b> run immediately when the equipment actually changes like in
