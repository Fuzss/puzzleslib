...
public final class ServerEntityEvents {
    ...
    public interface Join {
         ...
         * @param entitySpawnReason the spawn reason, if captured
         * @return <ul>
         *         <li>{@link EventResult#INTERRUPT INTERRUPT} to discard the entity</li>
         *         <li>{@link EventResult#PASS PASS} to add it normally</li>
         *         </ul>
         */
        EventResult onEntityJoin(Entity entity, ServerLevel serverLevel, boolean isLoadedFromDisk, @Nullable EntitySpawnReason entitySpawnReason);
    }
    ...
    public interface Load {
         ...
         * @param entitySpawnReason the spawn reason, if captured
         */
        void onEntityLoad(Entity entity, ServerLevel serverLevel, boolean isLoadedFromDisk, @Nullable EntitySpawnReason entitySpawnReason);
    }
