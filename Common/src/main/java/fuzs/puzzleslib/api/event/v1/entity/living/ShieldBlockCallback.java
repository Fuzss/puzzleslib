...
public interface ShieldBlockCallback {
     ...
     * @param damageAmount   the amount of damage that will be blocked, i.e. the full damage amount the entity is
     *                       attacked with
     * @return <ul>
     ...
     *         </ul>
     */
    EventResult onShieldBlock(LivingEntity blockingEntity, DamageSource damageSource, float damageAmount);
}
