...
public final class UseItemEvents {
    ...
    public interface Start {
         ...
         * @param interactionHand      the used hand from {@link LivingEntity#getUsedItemHand()}
    ...
    public interface Tick {
         ...
         * @return <ul>
         *         <li>{@link EventResult#INTERRUPT INTERRUPT} to immediately stop the item from being used, no methods that usually run on use release or finishing are called</li>
         *         <li>{@link EventResult#PASS PASS} to allow the item to continue ticking</li>
         *         </ul>
         */
        EventResult onUseItemTick(LivingEntity livingEntity, ItemStack itemStack, InteractionHand interactionHand, MutableInt remainingUseDuration);
    }
    ...
    public interface Stop {
         ...
         * <p>
         * {@link net.minecraft.world.item.Item#releaseUsing(ItemStack, Level, LivingEntity, int)} is called for the
         * item-specific behavior to apply, like shooting bows, crossbows and tridents.
         * <p>
         ...
         * @param remainingUseDuration the duration in ticks the stack has already been in use for
         * @return <ul>
         *         <li>{@link EventResult#INTERRUPT INTERRUPT} to prevent {@link net.minecraft.world.item.Item#releaseUsing(ItemStack, Level, LivingEntity, int)} from being called, directly proceeding to {@link LivingEntity#stopUsingItem()}</li>
         *         <li>{@link EventResult#PASS PASS} to allow the item to release normally by calling the dedicated vanilla method</li>
         *         </ul>
         */
        EventResult onUseItemStop(LivingEntity livingEntity, ItemStack itemStack, InteractionHand interactionHand, int remainingUseDuration);
    }
    ...
    public interface Finish {
         ...
         *
         * @param livingEntity      the entity using the item
         * @param itemStack         the item that is set to the entity's use hand after has finished, like a bowl from
         *                          eating stew, but most of the time when an item is fully consumed, like when eating
         *                          normal food, is simply returned and reduced by one item in the process
         * @param originalItemStack the copy of the item stack being used, made before using finished
         * @param interactionHand   the used hand from {@link LivingEntity#getUsedItemHand()}
         */
        void onUseItemFinish(LivingEntity livingEntity, MutableValue<ItemStack> itemStack, ItemStack originalItemStack, InteractionHand interactionHand);
    }
}
