...
public interface ArrowLooseCallback {
     ...
     * @param stack   the bow item stack
     ...
     * @return {@link EventResult#INTERRUPT} to prevent an arrow from being fired,
     * {@link EventResult#PASS} to let vanilla behavior run, which means an arrow is fired with all bow enchantments applied
     */
    EventResult onArrowLoose(Player player, ItemStack stack, Level level, MutableInt charge, boolean hasAmmo);
}
