...
public interface GatherPotentialSpawnsCallback {
     ...
     */
    void onGatherPotentialSpawns(ServerLevel level, StructureFeatureManager structureManager, ChunkGenerator generator, MobCategory category, BlockPos pos, List<MobSpawnSettings.SpawnerData> mobsAt);
}
