 ...
 * <p>
 * This is modeled after NeoForge's system for handling individual gui layers; for convenience all ids are the same as
 * the ones used there.
 * <p>
 ...
 * events currently cannot be canceled on Fabric as they are not yet fully implemented.
 */
...
public final class RenderGuiLayerEvents {
    ...
    public static final ResourceLocation STATUS_EFFECTS = registerGuiLayer("effects");
    public static final ResourceLocation BOSS_BAR = registerGuiLayer("boss_overlay");
    public static final ResourceLocation SLEEP_OVERLAY = registerGuiLayer("sleep_overlay");
    public static final ResourceLocation DEMO_TIMER = registerGuiLayer("demo_overlay");
    public static final ResourceLocation DEBUG_OVERLAY = registerGuiLayer("debug_overlay");
    public static final ResourceLocation SCOREBOARD = registerGuiLayer("scoreboard_sidebar");
    ...
    public static final ResourceLocation PLAYER_LIST = registerGuiLayer("tab_list");
    public static final ResourceLocation SUBTITLES = registerGuiLayer("subtitle_overlay");
