...
public interface RenderGuiCallback {
    ...
    /**
     * Called at the end of {@link net.minecraft.client.gui.Gui#render(GuiGraphics, float)} after vanilla has drawn all elements.
     ...
     */
    void onRenderGui(Minecraft minecraft, GuiGraphics guiGraphics, float tickDelta, int screenWidth, int screenHeight);
}
