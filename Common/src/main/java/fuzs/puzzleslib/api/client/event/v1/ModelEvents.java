...
public final class ModelEvents {
    ...
    @Deprecated(forRemoval = true)
    public static final EventInvoker<ModifyBakingResult> MODIFY_BAKING_RESULT = EventInvoker.lookup(
    ...
    public interface ModifyUnbakedModel {
         ...
         * <p>It is recommended for callers to cache returned models themselves, as the event runs for every single
         * model location, even when the models would match per identity.
         *
    ...
    public interface AfterModelLoading {
         ...
         * <p>Use a {@link Supplier} for {@link ModelManager} and {@link ModelBakery} to prevent an issue with loading
         * the {@link net.minecraft.client.renderer.Sheets} too early on Fabric,
    ...
    public interface ModifyBakingResult {
        ...
        /**
         * Fired when the resource manager is reloading models and models have been baked, but before they are passed on
         * for caching.
         * <p>Use a {@link Supplier} for {@link ModelBakery} to prevent an issue with loading the
         * {@link net.minecraft.client.renderer.Sheets} too early on Fabric,
         * preventing modded materials from being added.
         *
    ...
    /**
     * @deprecated use {@link net.minecraft.server.packs.resources.ResourceManagerReloadListener} instead and get baked
     *         models via {@link fuzs.puzzleslib.api.client.core.v1.ClientAbstractions#getBakedModel(ResourceLocation)}
     */
    @Deprecated(forRemoval = true)
    @FunctionalInterface
    public interface BakingCompleted {
        ...
        /**
         * Fired after the resource manager has reloaded models. Does not allow for modifying the models map, for that
         * use {@link ModifyBakingResult}.
         * <p>Use a {@link Supplier} for {@link ModelManager} and {@link ModelBakery} to prevent an issue with loading
         * the {@link net.minecraft.client.renderer.Sheets} too early on Fabric,
         * preventing modded materials from being added.
         *
