...
public final class ScreenTooltipFactory {
    ...
    public static Tooltip create(List<? extends FormattedText> formattedTexts) {
        return createTooltip(formattedTexts.stream().flatMap(ScreenTooltipFactory::splitTooltipLines).collect(Collectors.toList()));
    }
     ...
     * @return the tooltip instance
     */
    public static Tooltip createTooltip(List<FormattedCharSequence> tooltipLines) {
