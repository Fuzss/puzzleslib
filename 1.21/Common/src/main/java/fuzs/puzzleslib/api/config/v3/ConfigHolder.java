...
public interface ConfigHolder {
     ...
     * @return config name
     *
     * @deprecated replaced with {@link #getSimpleNameFactory()}
     */
    @Deprecated(forRemoval = true)
    static String simpleName(String modId) {
        return getSimpleNameFactory().apply(modId);
    }
     ...
     *
     * @deprecated replaced with {@link #getDefaultNameFactory(String)}
     */
    @Deprecated(forRemoval = true)
    static String defaultName(String modId, String type) {
        return getDefaultNameFactory(type).apply(modId);
    }
     ...
     * @return path to config in dir
     *
     * @deprecated replaced with {@link #getDirectoryNameFactory(String, String)}
     */
    @Deprecated(forRemoval = true)
