...
public interface ConfigHolder {
    ...
    static String defaultName(String modId, String type) {
        return "%s-%s.toml".formatted(modId, type);
    }
    ...
    interface Builder extends ConfigHolderRegistry, Buildable {
         ...
         * <p>
         * by default this is set to {@link #defaultName}, otherwise {@link #simpleName} and {@link #moveToDir} exist
         * for convenience
         *
