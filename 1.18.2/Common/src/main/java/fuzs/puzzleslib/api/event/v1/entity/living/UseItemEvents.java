...
public final class UseItemEvents {
    ...
    public interface Stop {
         ...
         * <p>{@link net.minecraft.world.item.Item#releaseUsing(ItemStack, Level, LivingEntity, int)} is called for item specific behavior to apply, like shooting bows, crossbows and tridents.
