...
public interface ItemModelOverrides {
    ItemModelOverrides INSTANCE = (Item item, ModelResourceLocation itemModel, ModelResourceLocation itemModelOverride, ItemDisplayContext... defaultContexts) -> {
     ...
     */
    void register(Item item, ModelResourceLocation itemModel, ModelResourceLocation itemModelOverride, ItemDisplayContext... defaultContexts);
}
