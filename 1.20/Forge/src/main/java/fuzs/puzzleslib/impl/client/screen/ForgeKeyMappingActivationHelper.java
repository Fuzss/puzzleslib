...
public final class ForgeKeyMappingActivationHelper implements KeyMappingActivationHelper {
    public static final BiMap<KeyActivationContext, IKeyConflictContext> KEY_CONTEXTS = ImmutableBiMap.of(
            KeyMappingActivationHelper.KeyActivationContext.UNIVERSAL, KeyConflictContext.UNIVERSAL,
            KeyMappingActivationHelper.KeyActivationContext.GAME, KeyConflictContext.IN_GAME,
            KeyMappingActivationHelper.KeyActivationContext.SCREEN, KeyConflictContext.GUI
    );
