...
public record CoreShadersContextForgeImpl(BiConsumer<ShaderInstance, Consumer<ShaderInstance>> consumer, ResourceProvider resourceManager) implements CoreShadersContext {
