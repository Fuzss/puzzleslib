...
public final class PackResourcesHelper {
    ...
    public static RepositorySource buildClientPack(Supplier<AbstractModPackResources> factory, String id, Component title, Component description, boolean required, boolean fixedPosition) {
        return buildClientPack(factory, new ResourceLocation(id, id), title, description, required, fixedPosition);
    }
     ...
     * @return the {@link RepositorySource} to be added to the {@link net.minecraft.server.packs.repository.PackRepository}
     */
    public static RepositorySource buildClientPack(Supplier<AbstractModPackResources> factory, ResourceLocation id, Component title, Component description, boolean required, boolean fixedPosition) {
        return buildClientPack(factory, id, title, description, required, fixedPosition, false);
    }
     ...
     * @return the {@link RepositorySource} to be added to the {@link net.minecraft.server.packs.repository.PackRepository}
     */
    public static RepositorySource buildClientPack(Supplier<AbstractModPackResources> factory, ResourceLocation id, Component title, Component description, boolean required, boolean fixedPosition, boolean hidden) {
        return buildClientPack(factory, id, title, description, required, fixedPosition, FeatureFlagSet.of(), hidden);
    }
    ...
    public static RepositorySource buildServerPack(Supplier<AbstractModPackResources> factory, String id, Component title, Component description, boolean required, boolean fixedPosition) {
        return buildServerPack(factory, new ResourceLocation(id, id), title, description, required, fixedPosition);
    }
     ...
     * @return the {@link RepositorySource} to be added to the {@link net.minecraft.server.packs.repository.PackRepository}
     */
    public static RepositorySource buildServerPack(Supplier<AbstractModPackResources> factory, ResourceLocation id, Component title, Component description, boolean required, boolean fixedPosition) {
        return buildServerPack(factory, id, title, description, required, fixedPosition, false);
    }
     ...
     * @return the {@link RepositorySource} to be added to the {@link net.minecraft.server.packs.repository.PackRepository}
     */
    public static RepositorySource buildServerPack(Supplier<AbstractModPackResources> factory, ResourceLocation id, Component title, Component description, boolean required, boolean fixedPosition, boolean hidden) {
        return buildServerPack(factory, id, title, description, required, fixedPosition, FeatureFlagSet.of(), hidden);
    }
