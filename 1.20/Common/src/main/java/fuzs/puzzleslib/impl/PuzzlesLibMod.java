...
public class PuzzlesLibMod extends PuzzlesLib implements ModConstructor {
    ...
    public void onAddDataPackFinders(PackRepositorySourcesContext context) {
        context.addRepositorySource(PackResourcesHelper.buildServerPack(DynamicPackResources.create(MOD_ID, dataProviderContext -> {
        ...
        }), id("dynamic_recipes"), Component.literal("Dynamic Recipes"), CommonComponents.EMPTY, true, true, true));
    }
