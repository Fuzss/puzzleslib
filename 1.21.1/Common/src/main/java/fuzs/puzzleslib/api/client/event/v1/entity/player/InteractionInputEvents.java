...
public final class InteractionInputEvents {
    ...
    public interface Use {
        ...
        /**
         * Runs before the client performs a use interaction based on {@link Minecraft#hitResult},
         * either using the held item on an entity (like a name tag), on a block (like pushing a button), or using the item itself (like throwing an ender pearl).
         * <p>This event is placed at the beginning of  on Forge,
    ...
    public interface Pick {
        ...
        /**
         * Runs before the client performs a pick interaction based on {@link Minecraft#hitResult}, setting a new item stack to the main hand if possible.
         * <p>This event is placed at the beginning of {@link Minecraft#pickBlock()}.
         *
         * @param minecraft the minecraft singleton instance
         * @param player    the current client player
         * @param hitResult the hit result the interaction is based on
