...
public class CopyTagShapelessRecipeBuilder extends ShapelessRecipeBuilder {
    ...
    public CopyTagShapelessRecipeBuilder(ItemLike result, int count) {
        super(result, count);
    }

    public static CopyTagShapelessRecipeBuilder shapeless(ItemLike result) {
        return shapeless(result, 1);
    }

    public static CopyTagShapelessRecipeBuilder shapeless(ItemLike result, int count) {
        return new CopyTagShapelessRecipeBuilder(result, count);
    }
