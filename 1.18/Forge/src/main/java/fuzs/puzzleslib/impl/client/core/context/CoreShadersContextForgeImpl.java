...
public record CoreShadersContextForgeImpl(BiConsumer<ShaderInstance, Consumer<ShaderInstance>> consumer,
                                          ResourceManager resourceManager) implements CoreShadersContext {
