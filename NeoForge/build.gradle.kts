...
multiloader {
    mixins {
        ...
        mixin(
            ...
            "EnchantedCountIncreaseFunctionNeoForgeMixin",
            "EnchantmentHelperNeoForgeMixin",
            "LootItemRandomChanceWithEnchantedBonusConditionNeoForgeMixin",
            "MenuProviderWithDataNeoForgeMixin",
            "TagsProviderNeoForgeMixin"
        )
        accessor(
            "BiomeSpecialEffectsBuilderNeoForgeAccessor",
            "MobSpawnSettingsBuilderNeoForgeAccessor",
            "NewRegistryEventNeoForgeAccessor"
        )
        clientAccessor("BlockColorsNeoForgeAccessor", "ItemColorsNeoForgeAccessor")
    }
}
