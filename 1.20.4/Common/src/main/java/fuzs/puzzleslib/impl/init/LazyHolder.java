...
/**
 * A {@link Holder} implementation similar to DeferredHolder on NeoForge, but extending {@link net.minecraft.core.Holder.Reference} to allow for using {@link Reference#key()}.
