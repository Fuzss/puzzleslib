...
public final class AbstractTagProvider {
    ...
    public abstract static class Items extends ItemTagsProvider implements TagProviderExtension<Item, IntrinsicHolderTagsProvider.IntrinsicTagAppender<Item>> {
        ...
        public Items(GatherDataEvent evt, String modId, CompletableFuture<TagLookup<Block>> blockTagsProvider) {
            this(evt.getGenerator().getPackOutput(), evt.getExistingFileHelper(), modId, evt.getLookupProvider(), blockTagsProvider);
        }

        public Items(PackOutput packOutput, ExistingFileHelper fileHelper, String modId, CompletableFuture<HolderLookup.Provider> lookupProvider, CompletableFuture<TagLookup<Block>> blockTagsProvider) {
        ...
        @Deprecated(forRemoval = true)
        public Items(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> lookupProvider, CompletableFuture<TagLookup<Block>> blockTagsProvider, String modId, ExistingFileHelper fileHelper) {
