...
public record CapabilityAdapter<T, C extends CapabilityComponent<T>>(Capability<C> capability,
                                                                     C component) implements ICapabilityProvider, INBTSerializable<CompoundTag> {
