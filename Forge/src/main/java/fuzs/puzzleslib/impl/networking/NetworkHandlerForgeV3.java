...
public class NetworkHandlerForgeV3 extends NetworkHandlerRegistry {
    private static final String PROTOCOL_VERSION = Integer.toString(1);

    private final SimpleChannel channel;
    private final AtomicInteger discriminator = new AtomicInteger();

    private NetworkHandlerForgeV3(SimpleChannel channel) {
    ...
    public static class ForgeBuilderImpl extends BuilderImpl {
        ...
        protected NetworkHandlerRegistry getHandler() {
            return new NetworkHandlerForgeV3(buildSimpleChannel(this.modId, this.clientAcceptsVanillaOrMissing, this.serverAcceptsVanillaOrMissing));
        }
