 ...
 */
public class ForgeLootTableModifyEvent extends Event {
    private final LootDataManager lootDataManager;
    private final ResourceLocation identifier;
    private final LootTable lootTable;

    public ForgeLootTableModifyEvent(LootDataManager lootDataManager, ResourceLocation identifier, LootTable lootTable) {
