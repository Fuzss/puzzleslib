...
public final class BlockModelLoadingEvents {
    ...
    public interface LoadModel {
         ...
         *
         * @param modelResourceLocation the model resource location for the model
         * @param unbakedModel          the unbaked model
         * @param blockState            the block state the model is loaded from
         * @return <ul>
         ...
         *         </ul>
         */
        EventResultHolder<UnbakedBlockStateModel> onLoadModel(ModelResourceLocation modelResourceLocation, UnbakedBlockStateModel unbakedModel, BlockState blockState);
    }
    ...
    public interface ModifyUnbakedModel {
         ...
         *         </ul>
         */
        EventResultHolder<UnbakedBlockStateModel> onModifyUnbakedModel(ModelResourceLocation modelResourceLocation, UnbakedBlockStateModel unbakedModel, ModelBaker modelBaker);
    }
    ...
    public interface ModifyBakedModel {
         ...
         *         </ul>
         */
        EventResultHolder<BakedModel> onModifyBakedModel(ModelResourceLocation modelResourceLocation, BakedModel bakedModel, UnbakedBlockStateModel unbakedModel, ModelBaker modelBaker);
    }
}
