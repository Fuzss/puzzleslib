    ...
    public static void registerEventHandlers() {
        ...
        INSTANCE.register(RenderGuiEvents.Before.class,
                ...
                (RenderGuiEvents.Before callback, RenderGuiEvent.Pre event) -> {
                    callback.onBeforeRenderGui(Minecraft.getInstance().gui,
        ...
        INSTANCE.register(RenderGuiEvents.After.class,
                ...
                (RenderGuiEvents.After callback, RenderGuiEvent.Post event) -> {
                    callback.onAfterRenderGui(Minecraft.getInstance().gui,
                            event.getGuiGraphics(),
                            event.getPartialTick());
                });
        ...
        INSTANCE.register(InventoryMobEffectsCallback.class,
                ...
                (InventoryMobEffectsCallback callback, ScreenEvent.RenderInventoryMobEffects event) -> {
                    ...
                    EventResult eventResult = callback.onInventoryMobEffects(event.getScreen(),
