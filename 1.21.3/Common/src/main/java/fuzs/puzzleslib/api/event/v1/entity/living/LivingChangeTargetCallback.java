...
public interface LivingChangeTargetCallback {
     ...
     * @param targetEntity the target to be set, can be <code>null</code>
     * @return <ul>
     ...
     *         </ul>
     */
    EventResult onLivingChangeTarget(LivingEntity livingEntity, DefaultedValue<LivingEntity> targetEntity);
}
