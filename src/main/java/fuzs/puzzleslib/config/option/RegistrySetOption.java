...
public class RegistrySetOption<T extends IForgeRegistryEntry<T>> extends CollectionOption<T, Set<T>> {

    private final IForgeRegistry<T> registry;

    RegistrySetOption(ForgeConfigSpec.ConfigValue<List<? extends String>> value, ModConfig.Type type, RegistrySetOptionBuilder<T> builder) {
    ...
    public static class RegistrySetOptionBuilder<T extends IForgeRegistryEntry<T>> extends CollectionOptionBuilder<T, Set<T>> {

        private final IForgeRegistry<T> registry;

        RegistrySetOptionBuilder(OptionBuilder previous, String name, Set<T> defaultValue, IForgeRegistry<T> registry) {
        ...
        CollectionOption<T, Set<T>> createOption(ForgeConfigSpec.ConfigValue<List<? extends String>> value, ModConfig.Type type) {
            ...
            return new RegistrySetOption<>(value, type, this);
        }
