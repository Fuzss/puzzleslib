...
import com.fuzs.puzzleslib.config.option.ConfigOption;
import com.fuzs.puzzleslib.config.option.OptionsBuilder;
import com.fuzs.puzzleslib.element.side.IClientElement;
import com.fuzs.puzzleslib.element.side.ICommonElement;
import com.fuzs.puzzleslib.element.side.IServerElement;
...
public abstract class AbstractElement extends EventListener implements IConfigurableElement, IRegistryElement<AbstractElement> {
    ...
    /**
     * empty element needed for some aspects of {@link com.fuzs.puzzleslib.config.ConfigManager}
     */
